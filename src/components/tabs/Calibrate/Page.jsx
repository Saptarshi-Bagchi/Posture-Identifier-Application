...
function MonthlyCalendar({ calendar }) {
  ...
  return <>
    <p className="mt-4 text-sm font-semibold text-foreground">{routineDayCount}-Day Correction Plan</p>
...
export default function CalibratePage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setResult({ ...analysis, calendar: null })
